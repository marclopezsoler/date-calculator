    ...
    <>
      ...
      >
        <section className="flex flex-col gap-4 items-center justify-center w-screen h-screen">
          ...
          <Link to="/convert-case" onClick={closeMenu} className="transition duration-200 sm:hover:scale-105 text-center"><LinkButton textColor={textColor} textValue={"CASE CONVERT"} fontSize={'xl'} translateText={translateText}/></Link>
